...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        Schema::table('inmo_properties', function (Blueprint $table) {
            $table->index(['operation_type', 'status', 'city', 'price'], 'idx_properties_operation_city');
            $table->index(['operation_type', 'category_id', 'status', 'city', 'price'], 'idx_properties_operation_category_city');
    ...
    public function down()
    {
        ...
        Schema::table('inmo_properties', function (Blueprint $table) {
            ...
            $table->dropIndex('idx_properties_operation_category_city');
